...
def generate():
    ...
    try:
        ...
        return jsonify({"error": "Произошла ошибка при генерации плана питания"}), 500
...
def regenerate_meal():
    ...
    try:
        ...
        return jsonify({"error": "Произошла ошибка при регенерации рецепта"}), 500
...
def update_meal():
    ...
    try:
        ...
        return jsonify({"error": "Произошла ошибка при обновлении рецепта"}), 500
